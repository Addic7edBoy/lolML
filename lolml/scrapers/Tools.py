...
class myTools(object):
    def __init__(self, *args):
        self.initialValues = {'matchupFoe': '../Data/matchups/foe/', 'matchupAlly': '../Data/matchups/ally/', 'gameStats': '../user_data/', 'test': '../temp/'}
